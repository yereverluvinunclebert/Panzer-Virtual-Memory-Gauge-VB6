   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.Frame fraGeneralInner 
         ...
         Begin VB.ComboBox cmbTickSwitchPref 
            Height          =   315
            ItemData        =   "frmPrefs.frx":8980
            Left            =   2010
            List            =   "frmPrefs.frx":8982
            Style           =   2  'Dropdown List
            TabIndex        =   165
            Top             =   975
            Width           =   4320
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PanzerVirtualMemoryGauge", """" & App.Path & "\" & "Panzer-Virtual-Memory-Gauge.exe""")
    Else
