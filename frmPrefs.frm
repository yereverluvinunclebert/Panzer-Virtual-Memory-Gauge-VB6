...
Begin VB.Form panzerPrefs 
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.Frame fraGeneralInner 
         ...
         Begin VB.ComboBox cmbTickSwitchPref 
            Height          =   315
            ItemData        =   "frmPrefs.frx":120B
            Left            =   2010
            List            =   "frmPrefs.frx":120D
            Style           =   2  'Dropdown List
            TabIndex        =   145
            Top             =   975
            Width           =   3720
   ...
   Begin VB.Menu prefsMnuPopmenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Panzer RAM Widget"
      End
      Begin VB.Menu blank 
         Caption         =   "-"
      End
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
'    End If
    ...
    If gblStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzVirtualMemoryGaugeWidget", """" & App.path & "\" & "Panzer Virtual Memory Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzVirtualMemoryGaugeWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\PzVirtualMemoryGauge", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeFunctions", gblGaugeFunctions, gblSettingsFile
        ...
        'sPutINISetting "Software\PzVirtualMemoryGauge", "clockFaceSwitchPref", gblClockFaceSwitchPref, gblSettingsFile
'        sPutINISetting "Software\PzVirtualMemoryGauge", "mainGaugeTimeZone", gblMainGaugeTimeZone, gblSettingsFile
'        sPutINISetting "Software\PzVirtualMemoryGauge", "mainDaylightSaving", gblMainDaylightSaving, gblSettingsFile
        'sPutINISetting "Software\PzVirtualMemoryGauge", "secondaryGaugeTimeZone", gblSecondaryGaugeTimeZone, gblSettingsFile
        'sPutINISetting "Software\PzVirtualMemoryGauge", "secondaryDaylightSaving", gblSecondaryDaylightSaving, gblSettingsFile
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "defaultEditor", gblDefaultEditor, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "clockHighDpiXPos", gblClockHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "clockHighDpiYPos", gblClockHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "clockLowDpiXPos", gblClockLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "clockLowDpiYPos", gblClockLowDpiYPos, gblSettingsFile
...
'    cmbMainDaylightSaving.ListIndex = Val(gblMainDaylightSaving)
    ...
    txtDefaultEditor.Text = gblDefaultEditor
    lblGitHub.Caption = "You can find the code for the Panzer Virtual Memory Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Panzer-Virtual-Memory-Gauge-VB6"
...
'        sliAnimationInterval.ToolTipText = "Adjust to make the animation smooth or choppy. Any adjustment in the interval takes place instantly. Lower values are smoother but the smoother it runs the more Virtual Memory it uses."
...
'        cmbMainDaylightSaving.ToolTipText = "Select and activate Daylight Savings Time for your area."
        ...
        cmbTickSwitchPref.ToolTipText = "The movement of the hand can be set to smooth or regular flicks, the smooth movement uses slightly more Virtual Memory."
