...
Begin VB.Form widgetPrefs 
   Caption         =   "Panzer Virtual Memory Gauge Preferences"
   ClientHeight    =   10545
   ClientLeft      =   60
   ClientTop       =   510
   ClientWidth     =   8880
   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":95DE
            Left            =   1530
            List            =   "frmPrefs.frx":95E0
            Style           =   2  'Dropdown List
            TabIndex        =   46
...
Private Sub optGaugeTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeTooltips", gblGaugeTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            ...
            sPutINISetting "Software\PzVirtualMemoryGauge", "gaugePrimaryHeightRatio", gblGaugePrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzVirtualMemoryGauge", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblGaugeSecondaryHeightRatio = fGauge.gaugeForm.WidgetRoot.Zoom
            sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeSecondaryHeightRatio", gblGaugeSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzVirtualMemoryGauge", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Private Sub Form_Load()
    ...
    Me.mnuAbout.Caption = "About Panzer Virtual Memory Gauge Cairo " & gblCodingEnvironment & " widget"
...
Private Sub initialisePrefsVars()
   ...
   On Error GoTo initialisePrefsVars_Error
    ...
    pCmbTickSwitchPrefBalloonTooltip = vbNullString
...
Public Sub MouseMoveOnComboText(sComboName As String)
    ...
    Select Case sComboName
        ...
        Case "cmbDebug"
         ...
         Case "cmbTickSwitchPref"
            sTitle = "Help on Debug Mode"
            sText = pCmbTickSwitchPrefBalloonTooltip
            If gblPrefsTooltips = "0" Then CreateToolTip cmbTickSwitchPref.hWnd, sText, , sTitle, , , , True
    End Select
...
Public Sub positionPrefsMonitor()
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\PzVirtualMemoryGauge", "prefsPrimaryHeightTwips", gblSettingsFile)
...
Private Sub chkDpiAwareness_Click()
    ...
    If pvtPrefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
...
Private Sub chkWidgetHidden_Click()
   On Error GoTo chkWidgetHidden_Click_Error
    ...
    sPutINISetting "Software\PzVirtualMemoryGauge", "widgetHidden", gblWidgetHidden, gblSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Panzer-Virtual-Memory-Gauge-VB6MkII\Panzer-Virtual-Memory-Gauge-VB6.vbp"
...
Private Sub btnSave_Click()
    ...
    gblPointerAnimate = LTrim$(Str$(cmbTickSwitchPref.ListIndex))
...
'    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "showTaskbar", gblShowTaskbar, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "showHelp", gblShowHelp, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
        
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeSize", gblGaugeSize, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "scrollWheelDirection", gblScrollWheelDirection, gblSettingsFile
                
        sPutINISetting "Software\PzVirtualMemoryGauge", "widgetFunctions", gblGaugeFunctions, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "pointerAnimate", gblPointerAnimate, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "samplingInterval", gblSamplingInterval, gblSettingsFile
        
              
        sPutINISetting "Software\PzVirtualMemoryGauge", "aspectHidden", gblAspectHidden, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "widgetPosition", gblWidgetPosition, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "widgetLandscape", gblWidgetLandscape, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "widgetPortrait", gblWidgetPortrait, gblSettingsFile

        sPutINISetting "Software\PzVirtualMemoryGauge", "prefsFont", gblPrefsFont, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeFont", gblGaugeFont, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "prefsFontSizeHighDPI", gblPrefsFontSizeHighDPI, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "prefsFontSizeLowDPI", gblPrefsFontSizeLowDPI, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "prefsFontItalics", gblPrefsFontItalics, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "prefsFontColour", gblPrefsFontColour, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzVirtualMemoryGauge", "windowLevel", gblWindowLevel, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "preventDragging", gblPreventDragging, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "opacity", gblOpacity, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "widgetHidden", gblWidgetHidden, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "hidingTime", gblHidingTime, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "ignoreMouse", gblIgnoreMouse, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
        
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "startup", gblStartup, gblSettingsFile

        sPutINISetting "Software\PzVirtualMemoryGauge", "enableSounds", gblEnableSounds, gblSettingsFile
'        sPutINISetting "Software\PzVirtualMemoryGauge", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\PzVirtualMemoryGauge", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\PzVirtualMemoryGauge", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\PzVirtualMemoryGauge", "volumeBoost", gblVolumeBoost, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "lastSelectedTab", gblLastSelectedTab, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "debug", gblDebug, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "dblClickCommand", gblDblClickCommand, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "openFile", gblOpenFile, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeHighDpiXPos", gblGaugeHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeHighDpiYPos", gblGaugeHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeLowDpiXPos", gblGaugeLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzVirtualMemoryGauge", "gaugeLowDpiYPos", gblGaugeLowDpiYPos, gblSettingsFile
...
'    chkVolumeBoost.Value = Val(gblVolumeBoost)
    ...
    lblGitHub.Caption = "You can find the code for the Panzer Virtual Memory Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/Panzer-Virtual-Memory-Gauge"
...
Private Sub sliSamplingInterval_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    If gblPrefsTooltips = "0" Then CreateToolTip sliSamplingInterval.hWnd, "Setting the sampling interval affects the frequency of the pointer updates.", _
                  TTIconInfo, "Help on the Sampling Interval", , , , True
End Sub
...
'        chkVolumeBoost.ToolTipText = "Sets the volume of the various sound elements, you can boost from quiet to loud."
        ...
        cmbTickSwitchPref.ToolTipText = "Here you can set the pointer to animate smoothly or flick from one value to another, smooth movement useds more CPU especially when coupled with a short sampling interval."
    Else
...
'    widgetPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzVirtualMemoryGauge", "skinTheme", gblSkinTheme, gblSettingsFile
