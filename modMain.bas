...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    widgetName = "Panzer Virtual Memory Gauge"
...
'        gblMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", gblSettingsFile)
        ...
        ' other
        gblClockHighDpiXPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockHighDpiXPos", gblSettingsFile)
        gblClockHighDpiYPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockHighDpiYPos", gblSettingsFile)
        
        gblClockLowDpiXPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockLowDpiXPos", gblSettingsFile)
        gblClockLowDpiYPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockLowDpiYPos", gblSettingsFile)
