...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    ' = "none"
    gblStartupFlg = True
    gblWidgetName = "Panzer Virtual Memory Gauge"
    thisPSDFullPath = App.Path & "\Res\Panzer Virtual Memory Gauge VB6.psd"
    ...
    menuForm.mnuAbout.Caption = "About Panzer Virtual Memory Gauge Cairo " & gblCodingEnvironment & " widget"
    ...
    Call readSettingsFile("Software\PzVirtualMemoryGauge", gblSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If gblFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "firstTimeRun", gblFirstTimeRun, gblSettingsFile
    End If
...
'        gblVolumeBoost = fGetINISetting(Location, "volumeBoost", gblSettingsFile)
        ...
        ' other
        gblGaugeHighDpiXPos = fGetINISetting("Software\PzVirtualMemoryGauge", "gaugeHighDpiXPos", gblSettingsFile)
        gblGaugeHighDpiYPos = fGetINISetting("Software\PzVirtualMemoryGauge", "gaugeHighDpiYPos", gblSettingsFile)
        gblGaugeLowDpiXPos = fGetINISetting("Software\PzVirtualMemoryGauge", "gaugeLowDpiXPos", gblSettingsFile)
        gblGaugeLowDpiYPos = fGetINISetting("Software\PzVirtualMemoryGauge", "gaugeLowDpiYPos", gblSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    gblSettingsDir = fSpecialFolder(feUserAppData) & "\PzVirtualMemoryGauge" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        gblUnhide = "true"
        sPutINISetting "Software\PzVirtualMemoryGauge", "unhide", gblUnhide, gblSettingsFile
