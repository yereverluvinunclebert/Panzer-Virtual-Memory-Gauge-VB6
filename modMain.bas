...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    Call readSettingsFile("Software\PzVirtualMemoryGauge", PzGSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If PzGFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzVirtualMemoryGauge", "firstTimeRun", PzGFirstTimeRun, PzGSettingsFile
    End If
...
'        PzGMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", PzGSettingsFile)
        ...
        ' other
        PzGClockHighDpiXPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockHighDpiXPos", PzGSettingsFile)
        PzGClockHighDpiYPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockHighDpiYPos", PzGSettingsFile)
        
        PzGClockLowDpiXPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockLowDpiXPos", PzGSettingsFile)
        PzGClockLowDpiYPos = fGetINISetting("Software\PzVirtualMemoryGauge", "clockLowDpiYPos", PzGSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    PzGSettingsDir = fSpecialFolder(feUserAppData) & "\PzVirtualMemoryGauge" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        PzGUnhide = "true"
        sPutINISetting "Software\PzVirtualMemoryGauge", "unhide", PzGUnhide, PzGSettingsFile
