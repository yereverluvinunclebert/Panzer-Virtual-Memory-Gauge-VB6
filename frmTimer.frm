...
Private Sub settingsTimer_Timer()
    ...
    PzGUnhide = fGetINISetting("Software\PzVirtualMemoryGauge", "unhide", PzGSettingsFile)

    If PzGUnhide = "true" Then
        'overlayWidget.Hidden = False
        fAlpha.gaugeForm.Visible = True
        sPutINISetting "Software\PzVirtualMemoryGauge", "unhide", vbNullString, PzGSettingsFile
    End If
